/*
Nuestro cliente está intenando calcular el promedio de una lista de números 
...
const array2string = listaNumeros.join(' + ')

console.log('Calculo de promedio:');
console.log(array2string, ' = ', promedioNumeros);